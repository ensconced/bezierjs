...
(function() {
  ...
  Bezier.prototype = {
    ...
    __frenet: function(t) {
      var o = this.compute(t);
      var t = this.derivative(t);
      var n = this.__normal3(t);
      var r = utils.cross(n, t);
      return { o: o, t: t, n: n, r: r };
    }
    __RMF: function(t) {
    ...
    __normal3: function(t) {
      ...
      var a = this.derivative(t),
          b = this.derivative2(t),
          c = utils.vplus(a,b),
          r = utils.cross(c, a),
          n = utils.cross(r, a);
      return n;
